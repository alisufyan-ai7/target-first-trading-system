#!/usr/bin/env python3
"""Engine O v0.2 — continuous-M5 statistical stretch reversion mechanics."""
...
def self_tests_engine_o_v02()->list[str]:
    tests=[]
    ...
    base=pd.Timestamp("2026-04-06T06:05:00Z")
    assert decision_allowed(base)
    assert decision_allowed(pd.Timestamp("2026-04-06T06:10:00Z"))
    assert decision_allowed(pd.Timestamp("2026-04-06T17:55:00Z"))
    assert not decision_allowed(pd.Timestamp("2026-04-06T06:00:00Z"))
